...
namespace UI
{
    namespace MainMenu
    {
        ...
        void MainMenuUIController::insertionSortButtonCallback()
        {
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(SortType::INSERTION_SORT);
        }
        ...
        void MainMenuUIController::selectionSortButtonCallback()
        {
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(SortType::SELECTION_SORT);
        }
        ...
        void MainMenuUIController::mergeSortButtonCallback()
        {
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(SortType::MERGE_SORT);
        }
        ...
        void MainMenuUIController::quickSortButtonCallback()
        {
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(SortType::QUICK_SORT);
        }
        ...
        void MainMenuUIController::radixSortButtonCallback()
        {
            GameService::setGameState(GameState::GAMEPLAY);
            ServiceLocator::getInstance()->getSoundService()->playSound(SoundType::BUTTON_CLICK);
            ServiceLocator::getInstance()->getGameplayService()->sortElement(SortType::RADIX_SORT);
        }
